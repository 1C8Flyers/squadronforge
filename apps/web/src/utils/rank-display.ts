...
const cadetRankName = (code: string): string | null => {
  switch (code) {
    case 'AB':
...
const seniorRankName = (code: string): string | null => {
  switch (code) {
    case 'SM':
...
export const formatRankDisplay = (value: string | null | undefined): string => {
